...
<div class="content-wrap">
	...
	<h1>
		...
		printf(
			...
			esc_html__( 'Search Results for: %s', 'graceful-blog' ),
	...
	<ul class="content-column">
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class('content-post'); ?>>
					...
					<?php if ( graceful_options( 'post_page_post_description' ) !== 'none' ) : ?>
						<div class="post-page-content">
							...
							if ( graceful_options( 'post_page_post_description' ) === 'content' ) {
								...
								$excerpt_length = graceful_blog_options( 'blog_grid_excerpt_length' );
					...
					<?php if ( graceful_options( 'post_page_show_more' ) ) : ?>
						<div class="continue-read">
							<a href="<?php the_permalink(); ?>"><?php echo esc_html__( 'Continue Reading', 'graceful-blog' ); ?></a>
						</div>
					<?php endif; ?>
					</footer>
		...
		<?php endwhile; else: ?>
			<div class="no-result-found">
				<h3><?php esc_html_e( 'Nothing Found!', 'graceful-blog' ); ?></h3>
				<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'graceful-blog' ); ?></p>
